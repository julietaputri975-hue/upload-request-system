...
| Fitur | Reviewer | Status Perbaikan |
| :--- | :--- | :--- |
...
2. Saya memahami pentingnya *Code Review* melalui *Pull Request* untuk memastikan kualitas kode sebelum di-*merge* ke *main*.
3. Proses ini membantu menjaga *maintainability* kode karena setiap fitur dibuat secara modular.
